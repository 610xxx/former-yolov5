...
"""
#🚀
#from utils.general import feature_visualization  特征可视化 

#🚀  from models import *

# import sys
# sys.path.append("../models/swintransformer.py")
...
from models.swintransformer import SwinStage, PatchMerging, PatchEmbed,SwinV2_CSPB #🚀 自定义函数包 主干网络swintransformer应用
...
class Detect(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference   Clouds heart no person,Clouds like me that no heart
...
#🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
#添加  class CLLA ,CLLABlock,CLLADetect 三类
...
class CLLADetect(nn.Module):
    ...
    def _make_grid(self, nx=20, ny=20, i=0):
        ...
        anchor_grid = (self.anchors[i].clone() * self.stride[i]) \
            .view((1, self.na, 1, 1, 2)).expand((1, self.na, ny, nx, 2)).float()
        return grid, anchor_grid
#移植swintransformer：github地址：https://github.com/cv516Buaa/tph-yolov5/blob/main/models/common.py#L19
#🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
class Model(nn.Module):
    ...
    def _forward_once(self, x, profile=False, visualize=False):
        ...
        for m in self.model:
           ...
           # visualize=Path('runs/detect/exp')#指定保存路径🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀可视化
            if visualize:
                feature_visualization(x, m.type, m.i, save_dir=visualize)
        return x
    #🚀
        # feature_vis = True     查看特定模块的特征
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
            ...
            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, C3, C3TR,C3STR, C3Ghost, C3SE, C3CBAM, C3ECA, C3CA,]:#增加四个注意力机制，小目标：C3SE, C3CBAM, C3ECA, C3CA：C3STR,(G_bneck,GhostNet）
                   #  BiFPN_Concat2,BiFPN_Concat3,BiFPN_Concat2,BiFPN_Concat3]:
        ...
        #      c2 = sum(ch[x] for x in f) 
         # 添加bifpn_concat结构
      #添加转置卷积🐸   yaml中替换邻近插值  [-1, 1, nn.ConvTranspose2d, [512, 4, 2, 1, 0, 512]], 效果比nearest好，大小跟上层conv同步
        ...
        m_ = nn.Sequential(*(m(*args) for _ in range(n))) if n > 1 else m(*args)  # module   少参数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5s_ca.yaml', help='model.yaml')
    parser.add_argument('--device', default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--profile', action='store_true', help='profile model speed')
    parser.add_argument('--test', action='store_true', help='test all yolo*.yaml')
    opt = parser.parse_args()
    opt.cfg = check_yaml(opt.cfg)  # check YAML    Customize
